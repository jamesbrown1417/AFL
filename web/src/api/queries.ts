...
export function useBuilderOdds(
  ...
  const query: OddsQuery = {
    ...
    max_diff_2025: metricFilters.maxDiff2025,
    min_diff_last_10: metricFilters.minDiffLast10,
    max_diff_last_10: metricFilters.maxDiffLast10,
    min_home_away_diff: metricFilters.minHomeAwayDiff,
    max_home_away_diff: metricFilters.maxHomeAwayDiff,
    min_win_loss_diff: metricFilters.minWinLossDiff,
