...
if (nrow(sportsbet_sgm_raw) > 0 && all(c("event_external_id", "competition_external_id", "class_external_id", "market_id", "player_id") %in% names(sportsbet_sgm_raw))) {
  sportsbet_sgm_raw <-
    rename(
      sportsbet_sgm_raw,
  ...
  sportsbet_sgm_over <- sportsbet_sgm_raw |>
  ...
  sportsbet_sgm_under <- sportsbet_sgm_raw |>
