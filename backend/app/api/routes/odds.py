...
def search_odds(
    ...
    event_id: Annotated[list[int] | None, Query()] = None,
    ...
    matchup_difficulty: Annotated[list[str] | None, Query()] = None,
    ...
    min_home_away_diff: float | None = Query(default=None),
    max_home_away_diff: float | None = Query(default=None),
    min_win_loss_diff: float | None = Query(default=None),
    max_win_loss_diff: float | None = Query(default=None),
    favorable_home_away: bool = Query(default=False),
    favorable_win_loss: bool = Query(default=False),
    ...
    rows = query_service.search_odds(
        ...
        matchup_difficulties=matchup_difficulty or [],
        date_from=date_from,
        date_to=date_to,
        min_edge=min_edge,
        min_price=min_price,
        ...
        min_home_away_diff=min_home_away_diff,
        max_home_away_diff=max_home_away_diff,
        min_win_loss_diff=min_win_loss_diff,
        max_win_loss_diff=max_win_loss_diff,
        favorable_home_away=favorable_home_away,
        favorable_win_loss=favorable_win_loss,
